...
declare -a StringArray=("atingupta-20201028-vm1.eastus.cloudapp.azure.com" "atingupta-20201028-vm2.eastus.cloudapp.azure.com" "atingupta-20201028-vm3.eastus.cloudapp.azure.com" "atingupta-20201028-vm4.eastus.cloudapp.azure.com" "atingupta-20201028-vm5.eastus.cloudapp.azure.com" )
...
for host in ${StringArray[@]}; do
   echo $host
   hostfilename=vm$i.neo4j.conf.inc.txt
   echo $hostfilename
   rm -rf $hostfilename
   ...
   cat /var/lib/neo4j/conf/neo4j.conf $hostfilename > /var/lib/neo4j/conf/neo4j.conf
